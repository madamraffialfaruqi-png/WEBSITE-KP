...
@section('content')
<div class="page active" id="page-program-sd">
  <div class="breadcrumb"><div class="breadcrumb-inner"><a href="{{ route('home') }}">Beranda</a><span class="sep">›</span><a href="{{ route('akademik') }}">Program</a><span class="sep">›</span><span class="current">SD Islam</span></div></div>
  <div class="program-hero">
    <div class="program-hero-inner container">
      <div>
        <div class="program-badge">Unit SD Islam</div>
        <h1>Sekolah Dasar Islam</h1>
        <p>Kurikulum integratif nasional and islami untuk siswa kelas 1–6. Menanamkan cinta ilmu, akhlak mulia, and hafalan Al-Qur'an sejak dini.</p>
        <div class="program-stats-row">
          <div class="ps-item"><div class="ps-num" id="ph-sd-siswa">{{ number_format($siswa, 0, ',', '.') }}</div><div class="ps-lbl">Siswa</div></div>
          <div class="ps-item"><div class="ps-num" id="ph-sd-guru">{{ number_format($guru, 0, ',', '.') }}</div><div class="ps-lbl">Guru</div></div>
          <div class="ps-item"><div class="ps-num">6</div><div class="ps-lbl">Tingkat Kelas</div></div>
        </div>
      ...
      <div class="program-photo-slot" style="position: relative; overflow: hidden; border: none; background: var(--navy);">
        ...
        @else
          <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; width: 100%; border: 2px dashed rgba(245,158,11,0.4); border-radius: var(--radius);">
            ...
            <div style="font-weight:600;color:rgba(245,158,11,0.8);font-size:12px;letter-spacing:0.1em;text-transform:uppercase">Foto Kegiatan SD</div>
            <div style="font-size:12px">Ganti dengan foto asli kegiatan SD</div>
          </div>
        @endif
      </div>
    </div>
  ...
  <section class="section">
    <div class="container">
      <div class="program-content-grid">
        <div>
          <h2 class="program-title">Tentang SD Islam Imam Syafi'i</h2>
          <p class="program-desc">SD Islam Imam Syafi'i mengintegrasikan kurikulum Kemendikbud dengan pendidikan agama yang mendalam. Siswa dididik untuk menguasai ilmu umum sekaligus menjadi pribadi yang beraqidah lurus and berakhlak mulia.</p>

          <div class="visi-misi-unit-box">
            <div class="visi-misi-grid">
              <div class="visi-misi-col">
                <h4 class="visi-misi-title">Visi SD Islam</h4>
                <p class="visi-misi-text">"{{ $stats->sd_vision ?? 'Belum diatur' }}"</p>
              </div>
              <div class="visi-misi-col divider">
                <h4 class="visi-misi-title">Misi SD Islam</h4>
          ...
          <div class="detail-photo-row">
            ...
            @empty
              <div class="detail-photo-slot program-gallery-slot" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;">
                ...
                <div style="font-weight:600;color:var(--gold);font-size:11px;text-transform:uppercase;letter-spacing:0.08em">Kegiatan SD</div>
          ...
          <div class="detail-photo-row">
            ...
            @empty
              <div class="detail-photo-slot program-gallery-slot" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px; grid-column: span 2; width: 100%; aspect-ratio: 16/5;">
                ...
                <div style="font-weight:600;color:var(--gold);font-size:11px;text-transform:uppercase;letter-spacing:0.08em">Ekstrakurikuler SD</div>
        ...
        <div class="program-info-sidebar">
          <h4>Informasi SD</h4>
          <div class="ppdb-row program-info-row"><span class="lbl">Kelas</span><span class="val">1 – 6</span></div>
          <div class="ppdb-row program-info-row"><span class="lbl">Usia Masuk</span><span class="val">6–7 Tahun</span></div>
          <div class="ppdb-row program-info-row"><span class="lbl">Hari Belajar</span><span class="val">Senin – Jumat</span></div>
          <div class="ppdb-row program-info-row"><span class="lbl">Jam</span><span class="val">07.00 – 14.30 WIB</span></div>
          <a href="https://wa.me/{{ $stats->sosmed_wa ?? '628123456789' }}" target="_blank" class="ppdb-wa-btn" style="margin-top:16px;">Tanya Info SD</a>
        </div>
      </div>
    </div>
  </section>
