...
<head>
    ...
    <title>Lupa Password - Sekolah Islam Imam Syafi'i</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <p class="subtitle">Reset Password Admin Sekolah</p>
        ...
        <form action="{{ route('admin.forgot-password.submit') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="username" id="username" class="form-control" placeholder="Masukkan Username Admin" value="{{ old('username') }}" required autofocus>
                </div>
            </div>
            <div class="form-group">
                <label for="secret_code" class="form-label">Kode Rahasia</label>
                <div class="input-wrapper">
                    <input type="password" name="secret_code" id="secret_code" class="form-control" placeholder="Masukkan Kode Rahasia" required>
                    <button type="button" id="toggleSecretCode" class="password-toggle" aria-label="Tampilkan kode rahasia">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <button type="button" id="togglePasswordConfirm" class="password-toggle" aria-label="Tampilkan password">
                        <svg class="eye-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="20" height="20">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        </svg>
            ...
            <div class="form-group">
                <label class="form-label">Kode Captcha</label>
                <div class="captcha-wrapper" style="display: flex; gap: 12px; align-items: center; margin-bottom: 12px;">
                    <div class="captcha-img-container" style="background: #1e293b; border-radius: 12px; overflow: hidden; display: flex; align-items: center; border: 1px solid rgba(255, 255, 255, 0.15);">
                        <img src="{{ route('captcha') }}" alt="Captcha" id="captcha-img" style="display: block; width: 120px; height: 45px; object-fit: contain;">
                    </div>
                    <button type="button" id="refresh-captcha" class="btn-refresh" style="background: none; border: none; color: var(--accent); cursor: pointer; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 4px;">
                ...
                <div class="input-wrapper">
                    <input type="text" name="captcha" id="captcha" class="form-control" placeholder="Masukkan Kode Captcha" required autocomplete="off">
                </div>
            </div>
    ...
    <script>
        ...
        setupToggle('#toggleSecretCode', '#secret_code');
        ...
        if (refreshBtn && captchaImg) {
            refreshBtn.addEventListener('click', function () {
                captchaImg.src = "{{ route('captcha') }}?t=" + new Date().getTime();
            });
        }
    </script>
</body>
